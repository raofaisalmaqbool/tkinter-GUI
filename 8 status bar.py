...
status_bar = Label(root, text="Image 1 of " + str(len(img_list)), relief=SUNKEN, anchor=E)
...
def my_function(img_num):
    ...
    status_bar = Label(root, text="Image " + str(img_num) + " out of " + str(len(img_list)), relief=SUNKEN, anchor=E)
